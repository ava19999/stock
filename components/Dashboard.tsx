      ...
      <div className="mt-6">
        <div className="flex justify-between items-center mb-4">
            <div className="flex items-center gap-3">
                ...
                <span className="text-xs text-gray-500 bg-gray-100 px-2 py-1 rounded-full">{totalCount} Item</span>
            </div>
        ...
        <div className="relative mb-4">
            ...
            <input 
                type="text" 
                placeholder="Cari (Tekan Enter atau Tunggu)..." 
                onChange={(e) => setSearchTerm(e.target.value)} 
                className="w-full pl-9 pr-4 py-2.5 bg-white border border-gray-200 rounded-xl text-xs focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 outline-none shadow-sm" 
            />
        </div>
        ...
        {loading ? (
            ...
            <div className="p-8 text-center text-gray-400 bg-white rounded-xl border border-dashed border-gray-200"><Package size={24} className="mx-auto mb-2 opacity-50"/><p className="text-xs">Tidak ada barang</p></div>
        ) : (
             <>
             {viewMode === 'grid' ? (
                // --- GRID VIEW ---
             ...
             {/* PAGINATION CONTROLS */}
             <div className="flex justify-between items-center mt-6 bg-white p-3 rounded-xl border border-gray-100 shadow-sm sticky bottom-20 md:bottom-4 z-20">
                <button 
                ...
                <span className="text-xs font-medium text-gray-500">
                    Halaman <span className="font-bold text-gray-900">{page}</span> dari {totalPages}
                </span>
                <button 

                                    ...
                                    <div key={log.id} className={`bg-white p-3 rounded-xl border shadow-sm transition-all ${isSelected ? 'border-blue-300 ring-1 ring-blue-100' : 'border-gray-100'}`}>
                                        <div className="flex justify-between items-start mb-2">
                                            ...
                                            {isSold ? (
                                                ...
                                                <span className="bg-red-50 text-red-600 text-[10px] font-bold px-2 py-1 rounded-full flex items-center gap-1"><XCircle size={10}/> Data Kurang</span>
                                            )}
                                        </div>
                                            ...
                                            <tr key={log.id || idx} className={`transition-colors ${isSold ? 'bg-gray-50 opacity-60' : (isSelected ? 'bg-blue-50' : 'hover:bg-gray-50')}`}>
                                                ...
                                                <td className="px-4 py-3 text-center whitespace-nowrap">
                                                    {isSold ? (
                                                        ...
                                                        <span className="inline-flex items-center gap-1 text-red-600 font-bold bg-red-50 px-2 py-0.5 rounded-full border border-red-100 text-[10px]"><Edit2 size={10}/> Data Kurang</span>
                                                    )}
                                                </td>
                                            </tr>
                                        );

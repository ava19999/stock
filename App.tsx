          ...
          <div className="flex items-center gap-2">
              ...
              {isAdmin ? (
                  <>
                    ...
                    <button onClick={() => setActiveView('scan')} className={`hidden md:flex items-center gap-2 px-4 py-2 text-sm font-semibold rounded-full transition-all ${activeView==='scan'?'bg-purple-50 text-purple-700 ring-1 ring-purple-200':'text-gray-500 hover:bg-gray-50'}`}><ScanBarcode size={18}/> Barang Masuk & Barang Keluar</button>
